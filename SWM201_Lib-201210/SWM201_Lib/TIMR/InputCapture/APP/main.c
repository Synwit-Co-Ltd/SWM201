...
{	
	...
	TIMR_Init(TIMR0, TIMR_MODE_IC, CyclesPerUs*4, 65536, 0);	//最大测量脉宽4us*65536 = 262ms
...
void TestSignal(void)
{
	...
	PWM_initStruct.Clkdiv = 30;					//F_PWM = 30M/30 = 1M
