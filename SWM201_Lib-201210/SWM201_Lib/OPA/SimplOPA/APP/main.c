...
{	
	...
	PORT_Init(PORTA, PIN13, PORTA_PIN13_OPA0_INN, 0);
	PORT_Init(PORTA, PIN12, PORTA_PIN12_OPA0_INP, 0);
	PORT_Init(PORTA, PIN11, PORTA_PIN11_OPA0_OUT, 0);
	...
	PORT_Init(PORTB, PIN9,  PORTB_PIN9_OPA2_OUT,  0);
	
	SYS->ACMPCR |= (1 << SYS_ACMPCR_CMP0MD_Pos);	// OPA模式
